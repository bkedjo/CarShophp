...
<footer class="footer position-relative">
        <div class="row g-0 justify-content-between align-items-center h-100">
          <div class="col-12 col-sm-auto text-center">
            ...
            <p class="mb-0 mt-2 mt-sm-0 text-900">Droit d'auteur reserve
                <span class="d-none d-sm-inline-block"></span><span class="d-none d-sm-inline-block mx-1">|
...
<script src="public/vendors/popper/popper.min.js"></script>
    ...
    <script src="public/vendors/feather-icons/feather.min.js"></script>
    <script src="public/vendors/dayjs/dayjs.min.js"></script>
    <script src="public/js/phoenix.js"></script>
